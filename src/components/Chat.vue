...
const suggestedChips = ref([
  { label: 'Fresh Produce Picks', prompt: 'Suggest healthy farm produce that is rich in vitamins and minerals.', icon: 'mdi-sprout' },
  { label: 'Balanced Meals', prompt: 'What farm produce can I combine for a balanced and nutritious meal?', icon: 'mdi-food-apple' },
  { label: 'Nutrition Tips', prompt: 'Give me simple nutrition tips using local farm produce.', icon: 'mdi-nutrition' },
  { label: 'Seasonal Harvest', prompt: 'What seasonal farm produce should I eat now for better nutrition?', icon: 'mdi-weather-sunny' }
])
  ...
  <v-container class="chat-container">
    <v-card class="mx-auto" max-width="400" elevation="4">
        <v-card-title class="bg-primary align-center">
            ...
            Shamba Online Nutritional Guide
        </v-card-title>
